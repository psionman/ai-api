...
from ai_api.constants import APP_TITLE, AUTHOR, HELP_URI
...
class MainMenu:
    ...
    def _file_menu_items(self) -> list:
        return [
            ...
            MenuItem(f"Billing {txt.ELLIPSIS}", self._show_billing_frame),
    ...
    def _show_billing_frame(self):
        """Display the billing frame."""
