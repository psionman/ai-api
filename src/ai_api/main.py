"""
A tkinter application for AI Interface.
"""
...
from ai_api import logger
from ai_api.constants import APP_TITLE, ICON_FILE
from ai_api.module_caller import ModuleCaller

ic_init()


def main() -> None:
    parser = argparse.ArgumentParser(description="AI Interface")
    parser.add_argument(
